...
cp -r productivity/google-workspace ~/.hermes/skills/productivity/google-workspace/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/google-workspace-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/google-workspace-skill.git ~/.hermes/skills/productivity/google-workspace/
```
...
```text
skill_view(name="productivity/google-workspace")
```
...
```text
Use the google workspace skill to <describe your specific task here>
```
...
```text
Gunakan skill google workspace untuk <deskripsikan tugas spesifik Anda di sini>
```
